  ...
  <div>
    <el-card>
      ...
      <el-row class="row-search">
        <el-col>
          <el-input class="user-search" clearable placeholder="请输用户名" v-model="query">
            <el-button slot="append" icon="el-icon-search"></el-button>
          </el-input>
          <el-button type="success" plain @click="showAddUserForm()">添加用户</el-button>
        </el-col>
      </el-row>
      <!-- 3.表格 -->
      <el-table :data="users" style="width: 100%">
        ...
        <el-table-column prop="user_email" label="邮箱" width="120"></el-table-column>
        <el-table-column prop="user_tel" label="电话" width="180"></el-table-column>
        <el-table-column label="创建时间" width="120">
          <template slot-scope="users">{{users.row.create_time | fmtdate}}</template>
        </el-table-column>
